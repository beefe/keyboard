    ...
    _renderKey(key, index) {
        return (
            <TouchableHighlight
                ...
                style={[keyStyle.wrapper, this.props.styleKey]}
      ...
      if (this.props.disableDot !== true) {
        ...
        return (
            <TouchableHighlight
                ...
                style={[keyStyle.wrapper, keyStyle.bg_d2d5dc, this.props.styleKey]}
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.row}>
                        ...
                        <TouchableHighlight
                            ...
                            style={[keyStyle.wrapper, this._disableClearButtonBackground(), this.props.styleKey]}
